...
Variables	../lesson5_variables/variables/ap_config.py								#存放AP IP、PROT、MAC、NAME的地方
Variables	../lesson5_variables/variables/ac_config.py								#存放AC IP、PROT的地方
...
Test AP radio 1 shutdown and config spectral enable radio 1
	[Documentation]    先radio 1 关闭，配置radio 1，能看到配置，但是配置不生效
	#****在AP 上关闭radio 1*********#
	Write Bare			\r\n	
	Read Until Prompt
	Write				configure 
